...
import io.fasthome.fenestram_messenger.call_impl.core.sipdroid.net.KeepAliveSip;
import io.fasthome.fenestram_messenger.call_impl.core.sipdroid.sipua.ui.ChangeAccount;
import io.fasthome.fenestram_messenger.call_impl.core.sipdroid.sipua.ui.LoopAlarm;
...
public class SipdroidEngine implements RegisterAgentListener {
	...
	public boolean StartEngine() {
			...
			if (wl == null) {
				if (!PreferenceManager.getDefaultSharedPreferences(getUIContext()).contains(PREF_KEEPON)) {
