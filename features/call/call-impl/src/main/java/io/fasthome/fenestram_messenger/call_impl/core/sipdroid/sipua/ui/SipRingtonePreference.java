...
import static io.fasthome.fenestram_messenger.call_impl.core.sipdroid.sipua.ui.Settings.DEFAULT_SIPRINGTONE;
...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : DEFAULT_SIPRINGTONE);
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(PREF_SIPRINGTONE,
