...
class ZoomBounds(private val settings: GeastureImageSettings) {
    companion object {
    ...
    fun restrict(zoom: Float, extraZoom: Float) = MathUtil.restrict(zoom, minZoom / extraZoom, maxZoom * extraZoom)
}
