...
public abstract class OrientationEventListenerWithInitial {
    private static final String TAG = "OrientationEventL";
    private static final boolean DEBUG = false;
    private static final boolean localLOGV = false;
    private int mOrientation = -2; // Не присваиваем ORIENTATION_UNKNOWN, чтобы листенер вызываелся еще и с начальной ориентацией.
     ...
     */
    public OrientationEventListenerWithInitial(Context context) {
     ...
     */
    public OrientationEventListenerWithInitial(Context context, int rate) {
